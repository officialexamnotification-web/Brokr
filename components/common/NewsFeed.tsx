  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-8 flex max-w-3xl flex-wrap justify-center gap-2 px-1">
            {categories.map((cat) => (
              <button
                key={cat.id}
                onClick={() => setCategory(cat.id)}
                className={`whitespace-nowrap rounded-full px-3 py-2 text-sm font-medium transition-all sm:px-4 ${
                category === cat.id

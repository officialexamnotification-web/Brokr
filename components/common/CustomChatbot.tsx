    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 left-6 z-50 bg-primary-600 hover:bg-primary-700 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 group"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 left-6 z-50 w-72 max-w-[calc(100vw-3rem)] bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-[#172554] dark:border-[#172554] overflow-hidden transition-all duration-300">
          {/* Header */}
          <div className="bg-[#172554] text-white p-4">
            <div className="flex items-center justify-between">
              ...
              {!isMinimized && (
                <>
                  <div className="h-64 overflow-y-auto p-4 space-y-4 bg-slate-50/80 dark:bg-slate-800/50 backdrop-blur-sm">
              ...
              {/* Input */}
              <div className="p-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm border-t border-[#172554] dark:border-[#172554]">

...
- **Formula**: Sum of prices Ã— Number of periods
...
const rawTools: Tool[] = [
  ...
  },
  {
    ...
    website: "https://upstox.com", affiliate: false, trending: true, featured: false,
    yearFounded: 2010, regulation: ["SEBI", "NSE", "BSE", "MCX", "CDSL"],
    supportedCountries: ["India"],
...
// REMOVED
  ...
  },
  {
    ...
    rating: null,
    description: "Multi-asset investment bank and trading platform with country-specific pricing and account terms.",
    longDescription: "Saxo provides access to stocks, ETFs, bonds, forex, CFDs and other products through SaxoTraderGO and SaxoTraderPRO. Its current account and pricing pages state that commissions, custody fees and other terms vary by country of residence and product.",
    category: "CFD Brokers", categoryId: 4,
    features: ["SaxoTraderGO", "SaxoTraderPRO", "Multi-asset access", "Account tiers", "Research and trading tools"],
    pros: ["Broad multi-asset offering", "No minimum funding on referenced account page", "Country-specific pricing disclosure", "Multiple platforms", "Banking and investment services"],
    cons: ["Fees vary by residency and product", "Custody and exit fees may apply", "CFDs and margin products are high risk", "Higher tiers have eligibility requirements"],
    pricing: "Country- and product-dependent", pricingDetail: "Saxo’s current pages publish indicative commissions, spreads and custody terms; exact pricing is shown in the platform and varies by country of residence, instrument and account tier.",
    minDeposit: "No minimum on referenced account page", platforms: ["SaxoTraderGO", "SaxoTraderPRO", "Web", "iOS", "Android"],
    website: "https://home.saxo", affiliate: false, trending: false, featured: false,
    sourceUrls: ["https://www.home.saxo/en-gb/rates-and-conditions/stocks/commissions", "https://www.home.saxo/en-sg/accounts/individual", "https://www.home.saxo/products/stocks"],
    lastVerifiedAt: "2026-08-02", dataStatus: "partially_verified",
    yearFounded: 1992, regulation: ["Country-specific Saxo entity and regulator; verify current license"],
    ...
    faq: [
      { q: "What is Saxo's minimum deposit?", a: "The referenced current account page says no minimum deposit, but funding requirements and account-tier eligibility can vary by country and product." },
    ],
  },
...
// REMOVED
  ...
  },
  {
    ...
    rating: null,
    description: "Global forex and CFD platform with region-specific entities and account terms.",
    longDescription: "Pepperstone offers Standard and Razor-style account structures. Spreads, commissions, available products, protections and account requirements vary by jurisdiction and instrument.",
    category: "Forex Brokers", categoryId: 1,
    features: ["MT4/MT5", "cTrader", "Standard and Razor Accounts"],
    pros: ["Multiple trading platforms", "Published account-cost examples", "Standard and commission-based structures"],
    cons: ["CFD leverage and loss risk", "Costs vary by jurisdiction and instrument", "Availability varies by country"],
    pricing: "From 0.0 pips; account dependent", pricingDetail: "Razor pricing uses raw-spread examples plus commission; the amount and account requirements vary by entity, product and base currency. Confirm current terms before trading.",
    minDeposit: "No universal minimum stated on cited global help page", platforms: ["MT4", "MT5", "cTrader"],
    website: "https://pepperstone.com", affiliate: false, trending: false, featured: false,
    yearFounded: 2010, regulation: ["Entity and jurisdiction dependent; verify current regulatory disclosure"],
    supportedCountries: ["Availability varies by country"],
    ...
    faq: [{ q: "Is Pepperstone regulated?", a: "The relevant regulator depends on the legal entity serving the client. Verify the entity and current register entry for your country rather than relying on a global brand label." }],
    sourceUrls: ["https://pepperstone.com/en-gb/trading-accounts/", "https://pepperstone.com/en-gb/trading/fees-and-costs/"],
    lastVerifiedAt: "2026-08-02", dataStatus: "partially_verified",
  },
  {
    id: 104, name: "CMC Markets", slug: "cmc-markets", logo: "CMC",
    rating: null,
    description: "Publicly listed multi-asset trading platform with region-specific CFD and investing products.",
    longDescription: "CMC Markets offers CFDs and, in selected markets, investing products. Instruments, fees, spread examples and account requirements vary by country and product.",
    category: "CFD Brokers", categoryId: 4,
    features: ["LSE Listed", "CFD Trading", "Spread Betting in Selected Regions"],
    pros: ["Public company", "Multi-asset platform", "Regional product coverage"],
    cons: ["CFD leverage and loss risk", "Costs vary by market", "Not all products are available everywhere"],
    pricing: "Instrument and region dependent", pricingDetail: "Spreads, commissions, financing and other charges depend on the instrument, account and local schedule; use the relevant CMC Markets pricing page.",
    minDeposit: "Product and region dependent", platforms: ["Web", "Mobile"],
    website: "https://cmcmarkets.com", affiliate: false, trending: false, featured: false,
    yearFounded: 1989, regulation: ["Entity and jurisdiction dependent; verify current regulatory disclosure"],
    supportedCountries: ["Availability varies by country"],
    depositMethods: ["Bank", "Card", "PayPal"],
    withdrawalTime: "Method, processing and review dependent",
    customerSupport: "Support availability varies by region and channel",
    ...
    faq: [{ q: "How should CMC Markets be compared?", a: "Check the relevant local entity, supported instruments, spread/commission schedule and funding costs. The LSE listing does not make every product or protection global." }],
    sourceUrls: ["https://www.cmcmarkets.com/", "https://www.cmcmarkets.com/en-gb/trading-costs"],
    lastVerifiedAt: "2026-08-02", dataStatus: "partially_verified",
  },
  {
  ...
  },
  {
    ...
    website: "https://icmarkets.com", affiliate: false, trending: false, featured: false,
  ...
  },
  {
    ...
    website: "https://pepperstone.com", affiliate: false, trending: true, featured: true,
  ...
  },
  {
    ...
    website: "https://oanda.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://cmcmarkets.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://saxobank.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://exness.com", affiliate: false, trending: true, featured: true,
  ...
  },
  {
    ...
    website: "https://icmarkets.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://avatrade.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://bybit.com", affiliate: false, trending: true, featured: true,
  ...
  },
  {
    ...
    minDeposit: "No minimum", platforms: ["Web", "iOS", "Android", "API", "TradingView"],
    website: "https://kucoin.com", affiliate: false, trending: true, featured: true,
  ...
  },
  {
    ...
    minDeposit: "$0", platforms: ["Web", "iOS", "Android", "Desktop"],
    website: "https://fidelity.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    minDeposit: "$0", platforms: ["Web", "iOS", "Android"],
    website: "https://vanguard.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    minDeposit: "$0", platforms: ["Web", "iOS", "Android"],
    website: "https://public.com", affiliate: false, trending: false, featured: false,
  ...
  },
  {
    ...
    website: "https://plus500.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://forex.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://dukascopy.com", affiliate: false, trending: false, featured: false,
  ...
  },
  {
    ...
    website: "https://coinbase.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    minDeposit: "No minimum", platforms: ["Web", "iOS", "Android", "API"],
    website: "https://huobi.com", affiliate: false, trending: false, featured: false,
    yearFounded: 2013, regulation: ["Various Global"],
    supportedCountries: ["170+ Countries", "Asia", "Europe", "Latin America"],
    depositMethods: ["Crypto", "Credit/Debit Card (via third party)", "P2P"],
    withdrawalTime: "Instant to 2 hours",
  ...
  },
  {
    ...
    minDeposit: "$0", platforms: ["Web", "iOS", "Android", "Desktop (thinkorswim)"],
    website: "https://tdameritrade.com", affiliate: false, trending: false, featured: true,
    yearFounded: 1975, regulation: ["SEC", "FINRA", "SIPC"],
    supportedCountries: ["USA"],
    depositMethods: ["Bank Transfer", "Check", "Wire Transfer"],
    withdrawalTime: "1-3 business days",
  ...
  },
  {
    ...
    minDeposit: "$0", platforms: ["Web", "iOS", "Android"],
    website: "https://betterment.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://wealthfront.com", affiliate: false, trending: false, featured: true,
    yearFounded: 2008, regulation: ["SEC", "FINRA"],
    supportedCountries: ["USA"],
    depositMethods: ["Bank Transfer", "Wire Transfer"],
    withdrawalTime: "1-3 business days",
  ...
  },
  {
    ...
    minDeposit: "$10", platforms: ["Web", "iOS", "Android", "MT4", "MT5"],
    website: "https://exness.com", affiliate: false, trending: false, featured: false,
  ...
  },
  {
    ...
    website: "https://bitpanda.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    website: "https://ftmo.com", affiliate: false, trending: false, featured: true,
    yearFounded: 2015, regulation: ["Various"],
  ...
  },
  {
    ...
    website: "https://the5ers.com", affiliate: false, trending: false, featured: true,
  ...
  },
  {
    ...
    longDescription: "BTG Pactual Academy offers 'Curso ExcelÃªncia no Day Trade', a free day trading course in partnership with B3, Brazil's stock exchange. As Latin America's largest investment bank, BTG Pactual provides this comprehensive 7-module course covering technical analysis fundamentals, Elliott Wave theory, Fibonacci, chart patterns, technical indicators, risk management, trading strategies, and trading psychology. The course offers lifetime access and is completely free, taught by specialists who actively trade in the markets.",
    category: "Education", categoryId: 8,
    ...
    faq: [
      { q: "Is BTG Pactual's course really free?", a: "Yes, the 'Curso ExcelÃªncia no Day Trade' is completely free with lifetime access. No payment required." },
  ...
  },
  {
    ...
    longDescription: "TBL Advisory offers 'TBL ??&AI?? ?????????', a completely free comprehensive learning program covering investment basics, practical chart analysis, and AI-powered trading strategies. The course covers everything from fundamental investment concepts to advanced chart analysis and modern AI-driven investment strategies. Students can learn at their own pace and experience simulation using actual tools. The course also includes TradingView setup support to apply learned chart analysis in real trading environments.",
    category: "Education", categoryId: 8,
  ...
  },
  {
    ...
    longDescription: "Monex Academy offers 'Japanese stock investment course ??????', a Japanese stock investment course supervised by Monex Securities, one of Japan's leading online securities companies. The course provides a free trial experience covering the appeal of Japanese stocks and the essence of corporate analysis. The full course includes 10 hours of lectures covering risk management, trading timing, stock selection, technical analysis, chart basics, financial statement analysis, and trading mechanisms. The free trial allows students to experience the course atmosphere before committing to the full program.",
    category: "Education", categoryId: 8,
  ...
  {
    id: 301, name: "XP EducaÃ§Ã£o Brazil", slug: "xp-educacao-brazil", logo: "XP",
    rating: null,
    description: "Free day trading masterclass. Pam Semezzato teaches technique and risk management.",
    longDescription: "XP EducaÃ§Ã£o offers a free masterclass titled 'Os 2 Pilares Essenciais no Day Trade' taught by Pam Semezzato, a national reference in day trading and CNPI-T analyst since 2018. The masterclass covers technique and risk management, including entry and exit planning, risk control, and reviewing results.",
    category: "Education", categoryId: 8,
    ...
    faq: [
      { q: "Is XP EducaÃ§Ã£o's masterclass really free?", a: "The listing describes the day trading masterclass as free; confirm current access terms with the provider." },
  ...
  },
  {
    ...
    longDescription: "Finantres MÃ©xico offers 'Curso Gratis para Invertir en ETFs en MÃ©xico', a course for the Latin American market focused on Mexico. It covers how ETFs work, portfolio construction, fees, volume, issuers, and common beginner considerations.",
    category: "Education", categoryId: 8,
  ...
  {
    id: 305, name: "S Broker bÃ¶rsenfit", slug: "sbroker-borsenfit", logo: "SB",
    rating: null,
    description: "Free stock market education platform. Learn stocks, trading, and wealth building.",
    longDescription: "S Broker's bÃ¶rsenfit is an education platform covering stocks, securities trading, and wealth building. It provides webinars and podcasts for people who want introductory stock-market information.",
    category: "Education", categoryId: 8,
    ...
    pricing: "Provider terms", pricingDetail: "The listing describes the education platform as free; confirm current access terms with S Broker.",
    minDeposit: "$0", platforms: ["Web"],
    ...
    faq: [
      { q: "Is bÃ¶rsenfit free?", a: "The listing describes free access; confirm current terms with S Broker." },
  ...
  },
  {
    ...
    website: "https://www.questrade.com", affiliate: false, trending: true, featured: true,
  ...
  },
  {
    ...
    longDescription: "Boursorama is a French online bank and brokerage platform, founded in 1995. As a subsidiary of SociÃ©tÃ© GÃ©nÃ©rale, it offers stock trading, banking accounts, savings products, and insurance. The platform states that it is regulated by AMF and ACPR; confirm the current legal entity and permissions with the relevant registers.",
    category: "Stock Brokers", categoryId: 3,
    features: ["Online Banking", "Stock Trading", "Low Fees", "Mobile App", "Savings Accounts", "Insurance Products", "French Market Focus"],
    pros: ["AMF/ACPR information is listed", "Pricing details are provided", "Integrated banking", "SociÃ©tÃ© GÃ©nÃ©rale group", "Mobile app", "French market context"],
  ...
  },
  {
    ...
    yearFounded: 2017, regulation: ["CNMV", "Banco de EspaÃ±a"],
    ...
    faq: [
      { q: "Is MyInvestor regulated?", a: "Yes, MyInvestor is regulated by CNMV (Spanish securities regulator) and Banco de EspaÃ±a (Spanish central bank)." },
...
// Keep one canonical record per slug. The original generated catalog contained
// repeated slugs, which made detail pages resolve to an arbitrary duplicate.
export const tools: Tool[] = rawTools.filter(
  (tool, index, all) => all.findIndex((candidate) => candidate.slug === tool.slug) === index
);

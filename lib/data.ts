...
export const categories: Category[] = [
  { id: 1, name: "Forex Brokers", slug: "forex-brokers", icon: "TrendingUp", count: 0, description: "Compare top forex brokers with competitive spreads and advanced trading platforms" },
  { id: 2, name: "Crypto Exchanges", slug: "crypto-exchanges", icon: "Bitcoin", count: 0, description: "Find the best cryptocurrency exchanges for trading Bitcoin, Ethereum and more" },
  { id: 3, name: "Stock Brokers", slug: "stock-brokers", icon: "BarChart3", count: 0, description: "Commission-free stock trading platforms with powerful research tools" },
  { id: 4, name: "CFD Brokers", slug: "cfd-brokers", icon: "LineChart", count: 0, description: "Trade CFDs on stocks, indices, commodities and currencies" },
  { id: 5, name: "Options Trading", slug: "options-trading", icon: "GanttChart", count: 0, description: "Advanced options trading platforms with strategy builders" },
  { id: 6, name: "Payment Systems", slug: "payment-systems", icon: "Wallet", count: 0, description: "Digital payment solutions and e-wallets for online transactions" },
  { id: 7, name: "Trading Tools", slug: "trading-tools", icon: "Wrench", count: 0, description: "Essential trading tools, screeners and analysis software" },
  { id: 8, name: "Education", slug: "education", icon: "GraduationCap", count: 0, description: "Trading courses, webinars and educational resources" },
];
